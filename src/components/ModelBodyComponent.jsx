...
const ModelBodyComponent = ({stateProduct, form, handleOnchange, handleOnchangeAvatar, onFinish, isLoading, title}) => {
    return (
        <Modal.Body>
          <Form
            name="basic"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <img src={stateProduct?.image} alt="image" style={{objectFit: 'cover', position: 'absolute', top:'0px', left: '0px', width: '100%', height: '100%'}} />
                </Button>
              </Upload> 
                )}
            </Form.Item>
            ...
            >
              <Input value={stateProduct.age} onChange={handleOnchange}  name='age'/>
            </Form.Item>
            ...
            >
              <Input value={stateProduct.bmi} onChange={handleOnchange}  name='bmi'/>
            </Form.Item>
