            ...
            <MDBRow className='g-0'>
              ...
              <MDBCol md='6'>
                <MDBCardBody className='d-flex flex-column'>
                  ...
                  <h2 className="fw-normal my-4 pb-3 title" style={{letterSpacing: '1px', textAlign: 'center', margin: '0'}}>ĐĂNG NHẬP</h2>
                    <div className='input'>
                  ...
                  <div className='footer'>
                    ...
                    <div className='button' style={{marginTop: '15px', display: 'flex', alignItems: 'center'}}>
                      <div style={{marginRight: '20px'}}>
                        ...
                        <Button disabled={false} onClick={handleSignIn} className='btn-login'
                  ...
                  <div className='qmk-dk'>
                      ...
                      <a href="/sign-up" style={{color: '#393f81'}}>Đăng ký</a>
                  </div>
                </MDBCardBody>
              </MDBCol>
            </MDBRow>
